                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <?php
                                if($error_message != '') {
                                    echo "<div class='error' style='padding: 20px;background:#f1f1f1;margin-bottom:30px;'>".$error_message."</div>";
                                }
                                if($success_message != '') {
                                    echo "<div class='success' style='padding: 20px;background:#f1f1f1;margin-bottom:30px;'>".$success_message."</div>";
                                }
                                ?>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="password" class="form-control" name="cust_password" pattern="^(?=.*[A-Z]+[a-z]+[@#_0-9]).{8,}$" title="Must contain at least one uppercase and lowercase letter, special symbol, a number, and at least 8 or more characters" required>
                                </div>
                                <div class="col-md-6 form-group">
